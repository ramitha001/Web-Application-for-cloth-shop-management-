...
<head>
    <meta charset="utf-8">
    <title>Kid update Function</title>
	<link rel="stylesheet" type="text/css" href="kidupdatefunctioncss.css">
...
$query = "select * from kidboyproductitems where p_kidboy_id = $pid ";
...
if (isset($_POST['update']))
{
   ...
   $img_tmp= $_FILES['img']['tmp_name'];
	...
	move_uploaded_file($img_tmp,"../../Products Insert/kid items/productImages/$img");

    $query = "UPDATE kidboyproductitems set ";
    $query .= "p_name = '{$name}', ";
    $query .= "p_description = '{$description}', ";
    $query .= "p_price = '{$price}', ";
    $query .= "p_image   = '{$img}' ";
    $query .= "where p_kidboy_id  = {$id} ";
    ...
    <div class="updateform">
       <center>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
			...
			<button name="Back" type="submit" formaction="kiddisplay.php">Back</button>
