...
<body>
<h1 align="center" > <font color="#66D83E"> <font size="30">  kid's Cloth Items </font>  </font>  </h1>
<center>
    <table class="table" border="2">
        ...
        <?php
        {
          ...
          while ($row = mysqli_fetch_assoc($select_cloths)) {
            ...
            echo "<tr>";
            echo "<td>$p_kidboy_id</td>";
            echo "<td>$p_name</td>";
            echo "<td>$p_description</td>";
            echo "<td>$p_price</td>";
           
            echo "<td><a href='kid update function.php?edit={$p_kidboy_id}'>Update</a></td>";
