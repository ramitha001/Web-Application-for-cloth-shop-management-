...
<body>
<h1 align="center" > <font color="#66D83E"> <font size="30">  Mens's Cloth Items </font>  </font>  </h1>
<center>
    <table class="table" border="2">
        ...
        <?php
        {
          ...
          while ($row = mysqli_fetch_assoc($select_cloths)) {
            ...
            echo "<td><a href='men update function.php?edit={$p_men_id}'>Update</a></td>";
