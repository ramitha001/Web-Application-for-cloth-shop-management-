...
<head>
    <meta charset="utf-8">
    <title>Women update Function</title>
	<link rel="stylesheet" type="text/css" href="womenupdatefunctioncss.css">
...
$query = "select * from womenproductitems where p_women_id = $pid ";
...
if (isset($_POST['update']))
{
   ...
   $img= $_FILES['img']['name'];
    ...
    $query = "UPDATE womenproductitems set ";
    $query .= "p_name = '{$name}', ";
    $query .= "p_description = '{$description}', ";
    $query .= "p_price = '{$price}', ";
    $query .= "p_image   = '{$img}' ";
    $query .= "where p_women_id  = {$id} ";
    ...
    <div class="updateform">
       <center>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
			...
			<button name="Back" type="submit" formaction="womendisplay.php">Back</button>
